...
THORNode 3.15.0 removed loan and saver quote endpoints. `estimateAddSaver`, `estimateWithdrawSaver`, `getLoanQuoteOpen`, and `getLoanQuoteClose` are now deprecated and throw descriptive errors.
