 ...
 */
export const getRandomArbitrary = async (max: number, min: number) => {
 ...
 */
export const getRandomAssetCryptoAmount = async (tcQuery: ThorchainQuery, assetAmount: CryptoAmount) => {
