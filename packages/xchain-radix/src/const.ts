...
export const RADIX_ASSET_ID = 'resource_tdx_2_1tknxxxxxxxxxradxrdxxxxxxxxx009923554798xxxxxxxxxtfd2jc'

export const XrdAssetMainnet: Asset = {
  symbol: `XDR-${RADIX_ASSET_ID}`,
  ticker: 'XRD',
...
export const feesEstimationPublicKeys: { [networkId: number]: FeesEstimationParams } = {
  [NetworkId.Mainnet]: {
    ...
    resourceAddress: RADIX_ASSET_ID,
