 ...
 * 
 * @export
 * @interface CACAOPoolResponse
 */
export interface CACAOPoolResponse {
    /**
     * 
     * @type {POL}
     * @memberof CACAOPoolResponse
     */
    'pol': POL;
    /**
     * 
 ...
 * 
 * @export
 * @interface CACAOPoolResponseProviders
 */
export interface CACAOPoolResponseProviders {
    /**
     * the units of CACAOPool owned by providers (including pending)
     * @type {string}
     * @memberof CACAOPoolResponseProviders
     */
    'units': string;
    /**
 ...
 * 
 * @export
 * @interface CACAOPoolResponseReserve
 */
export interface CACAOPoolResponseReserve {
    /**
     * the units of CACAOPool owned by the reserve
     * @type {string}
     * @memberof CACAOPoolResponseReserve
     */
    'units': string;
    /**
 ...
 * 
 * @export
 * @interface CACAOProvider
 */
export interface CACAOProvider {
    /**
     * 
     * @type {string}
     * @memberof CACAOProvider
     */
 ...
 * 
 * @export
 * @interface CACAOProvidersResponse
 */
export interface CACAOProvidersResponse extends Array<CACAOProvider> {
}
/**
 * 
 * @export
...
export interface InboundAddress {
    ...
    /**
     * The chain\'s observed fee rate in gas_rate_units (see gas_rate_units), before the 1.5x that makes an outbound more likely to have a sufficient gas rate.  Used by validators to check whether they need to report a fee change.
     * @type {string}
     * @memberof InboundAddress
     */
...
export interface OutboundFee {
    ...
    'outbound_fee': string;
    /**
     * Total CACAO the network has withheld as fees to later cover gas costs for this asset\'s outbounds
     * @type {string}
     * @memberof OutboundFee
     */
    'fee_withheld_cacao'?: string;
    /**
     * Total CACAO the network has spent to reimburse gas costs for this asset\'s outbounds
     * @type {string}
     * @memberof OutboundFee
     */
    'fee_spent_cacao'?: string;
    /**
     * amount of CACAO by which the fee_withheld_cacao exceeds the fee_spent_cacao
     * @type {string}
     * @memberof OutboundFee
     */
    'surplus_cacao'?: string;
    /**
     * dynamic multiplier basis points, based on the surplus_cacao, affecting the size of the outbound_fee
     * @type {string}
     * @memberof OutboundFee
     */
...
export interface QueueResponse {
    ...
    /**
     * scheduled outbound clout in CACAO
     * @type {string}
     * @memberof QueueResponse
     */
 ...
 * 
 * @export
 * @interface ShieldedMemoConfig
 */
export interface ShieldedMemoConfig {
    /**
     * Zcash Unified Address for receiving shielded memos
     * @type {string}
     * @memberof ShieldedMemoConfig
     */
    'unified_address'?: string;
    /**
     * Unified Incoming Viewing Key (UIVK) containing both Sapling and Orchard components
     * @type {string}
     * @memberof ShieldedMemoConfig
     */
    'uivk'?: string;
    /**
     * Whether shielded memo support is enabled
     * @type {boolean}
     * @memberof ShieldedMemoConfig
     */
    'enabled': boolean;
...
export interface SwapperCloutResponse {
    ...
    'address': string;
    /**
     * clout score, which is the amount of cacao spent on swap fees
     * @type {string}
     * @memberof SwapperCloutResponse
     */
    'score'?: string;
...
export interface TradeAccountResponse {
    ...
    'owner': string;
    /**
     * last mayachain height trade assets were added to trade account
     * @type {number}
     * @memberof TradeAccountResponse
     */
    'last_add_height'?: number;
    /**
     * last mayachain height trade assets were withdrawn from trade account
     * @type {number}
     * @memberof TradeAccountResponse
     */
    'last_withdraw_height'?: number;
...
export interface TxDetailsResponse {
    ...
    /**
     * the mayachain height at which a refund was scheduled/emitted
     * @type {number}
     * @memberof TxDetailsResponse
     */
    'refund_height'?: number;
    /**
     * the amount refunded to the inbound source
     * @type {string}
     * @memberof TxDetailsResponse
     */
    ...
    /**
     * the reason for the failure of the most recent streaming swap attempt, which resulted in a refund
     * @type {string}
     * @memberof TxDetailsResponse
     */
...
export interface TxOutItem {
    ...
    'height'?: number;
    /**
     * clout spent in CACAO for the outbound
     * @type {string}
     * @memberof TxOutItem
     */
    'clout_spent'?: string;
...
export const BlockApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        block: async (height?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/mayachain/block`;
...
/**
 * CACAOPoolApi - axios parameter creator
 * @export
 */
export const CACAOPoolApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         * @throws {RequiredError}
         */
        cacaoPool: async (height?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/mayachain/cacaopool`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        cacaoProvider: async (address: string, height?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'address' is not null or undefined
            assertParamExists('cacaoProvider', 'address', address)
            const localVarPath = `/mayachain/cacao_provider/{address}`
         ...
         * @throws {RequiredError}
         */
        cacaoProviders: async (height?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/mayachain/cacao_providers`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
/**
 * CACAOPoolApi - functional programming interface
 * @export
 */
export const CACAOPoolApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = CACAOPoolApiAxiosParamCreator(configuration)
    return {
        /**
         * Returns the pool information for the CACAO pool.
         * @param {number} [height] optional block height, defaults to current tip
         ...
         * @throws {RequiredError}
         */
        async cacaoPool(height?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CACAOPoolResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.cacaoPool(height, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Returns the CACAO Provider information for an address.
         ...
         * @throws {RequiredError}
         */
        async cacaoProvider(address: string, height?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CACAOProvider>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.cacaoProvider(address, height, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Returns all CACAO Providers.
         ...
         * @throws {RequiredError}
         */
        async cacaoProviders(height?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CACAOProvidersResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.cacaoProviders(height, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
/**
 * CACAOPoolApi - factory interface
 * @export
 */
export const CACAOPoolApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = CACAOPoolApiFp(configuration)
    return {
        /**
         * Returns the pool information for the CACAO pool.
         * @param {number} [height] optional block height, defaults to current tip
         ...
         * @throws {RequiredError}
         */
        cacaoPool(height?: number, options?: any): AxiosPromise<CACAOPoolResponse> {
            return localVarFp.cacaoPool(height, options).then((request) => request(axios, basePath));
        },
        /**
         * Returns the CACAO Provider information for an address.
         * @param {string} address 
         ...
         * @throws {RequiredError}
         */
        cacaoProvider(address: string, height?: number, options?: any): AxiosPromise<CACAOProvider> {
            return localVarFp.cacaoProvider(address, height, options).then((request) => request(axios, basePath));
        },
        /**
         * Returns all CACAO Providers.
         * @param {number} [height] optional block height, defaults to current tip
         ...
         * @throws {RequiredError}
         */
        cacaoProviders(height?: number, options?: any): AxiosPromise<CACAOProvidersResponse> {
            return localVarFp.cacaoProviders(height, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * CACAOPoolApi - object-oriented interface
 * @export
 * @class CACAOPoolApi
 * @extends {BaseAPI}
 */
export class CACAOPoolApi extends BaseAPI {
    /**
     * Returns the pool information for the CACAO pool.
     * @param {number} [height] optional block height, defaults to current tip
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof CACAOPoolApi
     */
    public cacaoPool(height?: number, options?: AxiosRequestConfig) {
        return CACAOPoolApiFp(this.configuration).cacaoPool(height, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CACAOPoolApi
     */
    public cacaoProvider(address: string, height?: number, options?: AxiosRequestConfig) {
        return CACAOPoolApiFp(this.configuration).cacaoProvider(address, height, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CACAOPoolApi
     */
    public cacaoProviders(height?: number, options?: AxiosRequestConfig) {
        return CACAOPoolApiFp(this.configuration).cacaoProviders(height, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const CloutApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        swapperClout: async (address: string, height?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/mayachain/clout/swap/{address}`
                .replace(`{${"address"}}`, encodeURIComponent(String(address)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const InvariantsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        invariant: async (invariant: string, height?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/mayachain/invariant/{invariant}`
        ...
        invariants: async (height?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/mayachain/invariants`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const NetworkApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        outboundFeeAsset: async (asset: string, height?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/mayachain/outbound_fee/{asset}`
                .replace(`{${"asset"}}`, encodeURIComponent(String(asset)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
        ...
        outboundFees: async (height?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/mayachain/outbound_fees`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const QueueApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        queueSwap: async (height?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/mayachain/queue/swap`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const QuoteApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} [affiliateBps] the affiliate fee in basis points; use \&quot;/\&quot; to separate multiple values
         * @param {string} [affiliate] the affiliate (address or mayaname); use \&quot;/\&quot; to separate multiple values
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        quoteswap: async (height?: number, fromAsset?: string, toAsset?: string, amount?: number, destination?: string, refundAddress?: string, streamingInterval?: number, streamingQuantity?: number, toleranceBps?: number, liquidityToleranceBps?: number, affiliateBps?: string, affiliate?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const QuoteApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async quoteswap(height?: number, fromAsset?: string, toAsset?: string, amount?: number, destination?: string, refundAddress?: string, streamingInterval?: number, streamingQuantity?: number, toleranceBps?: number, liquidityToleranceBps?: number, affiliateBps?: string, affiliate?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<QuoteSwapResponse>> {
...
export const QuoteApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        quoteswap(height?: number, fromAsset?: string, toAsset?: string, amount?: number, destination?: string, refundAddress?: string, streamingInterval?: number, streamingQuantity?: number, toleranceBps?: number, liquidityToleranceBps?: number, affiliateBps?: string, affiliate?: string, options?: any): AxiosPromise<QuoteSwapResponse> {
...
export class QuoteApi extends BaseAPI {
     ...
     * @memberof QuoteApi
     */
    public quoteswap(height?: number, fromAsset?: string, toAsset?: string, amount?: number, destination?: string, refundAddress?: string, streamingInterval?: number, streamingQuantity?: number, toleranceBps?: number, liquidityToleranceBps?: number, affiliateBps?: string, affiliate?: string, options?: AxiosRequestConfig) {
...
export const StreamingSwapApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        streamSwap: async (hash: string, height?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/mayachain/swap/streaming/{hash}`
        ...
        streamSwaps: async (height?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/mayachain/swaps/streaming`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const TSSApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        keygenPubkey: async (height: number, pubkey: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/mayachain/keygen/{height}/{pubkey}`
...
export const TradeAccountApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        tradeAccount: async (address: string, height?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/mayachain/trade/account/{address}`
                .replace(`{${"address"}}`, encodeURIComponent(String(address)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const TradeAccountsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} asset Trade asset (tilde-separated, e.g., BTC~BTC)
         * @param {number} [height] optional block height, defaults to current tip
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        tradeAccounts: async (asset: string, height?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/mayachain/trade/accounts/{asset}`
                .replace(`{${"asset"}}`, encodeURIComponent(String(asset)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const TradeUnitApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        tradeUnit: async (asset: string, height?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/mayachain/trade/unit/{asset}`
                .replace(`{${"asset"}}`, encodeURIComponent(String(asset)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const TradeUnitsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        tradeUnits: async (height?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/mayachain/trade/units`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const TransactionsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        txInVoter: async (hash: string, height?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'hash' is not null or undefined
            assertParamExists('txInVoter', 'hash', hash)
            const localVarPath = `/mayachain/tx/in/{hash}`
                .replace(`{${"hash"}}`, encodeURIComponent(String(hash)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        txOutVoter: async (hash: string, height?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'hash' is not null or undefined
            assertParamExists('txOutVoter', 'hash', hash)
            const localVarPath = `/mayachain/tx/out/{hash}`
                .replace(`{${"hash"}}`, encodeURIComponent(String(hash)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
        ...
        txSigners: async (hash: string, height?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/mayachain/tx/details/{hash}`
                .replace(`{${"hash"}}`, encodeURIComponent(String(hash)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
        ...
        txStages: async (hash: string, height?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/mayachain/tx/stages/{hash}`
                .replace(`{${"hash"}}`, encodeURIComponent(String(hash)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
        ...
        txStatus: async (hash: string, height?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/mayachain/tx/status/{hash}`
                .replace(`{${"hash"}}`, encodeURIComponent(String(hash)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const TransactionsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async txInVoter(hash: string, height?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TxDetailsResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.txInVoter(hash, height, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Returns the outbound transaction voter for a provided hash.
         ...
         * @throws {RequiredError}
         */
        async txOutVoter(hash: string, height?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TxDetailsResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.txOutVoter(hash, height, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Returns the signers for a provided inbound or outbound hash.
...
export const TransactionsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        txInVoter(hash: string, height?: number, options?: any): AxiosPromise<TxDetailsResponse> {
            return localVarFp.txInVoter(hash, height, options).then((request) => request(axios, basePath));
        },
        /**
         * Returns the outbound transaction voter for a provided hash.
         * @param {string} hash 
         ...
         * @throws {RequiredError}
         */
        txOutVoter(hash: string, height?: number, options?: any): AxiosPromise<TxDetailsResponse> {
            return localVarFp.txOutVoter(hash, height, options).then((request) => request(axios, basePath));
        },
        /**
         * Returns the signers for a provided inbound or outbound hash.
         * @param {string} hash 
...
export class TransactionsApi extends BaseAPI {
     ...
     * @memberof TransactionsApi
     */
    public txInVoter(hash: string, height?: number, options?: AxiosRequestConfig) {
        return TransactionsApiFp(this.configuration).txInVoter(hash, height, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TransactionsApi
     */
    public txOutVoter(hash: string, height?: number, options?: AxiosRequestConfig) {
        return TransactionsApiFp(this.configuration).txOutVoter(hash, height, options).then((request) => request(this.axios, this.basePath));
    }
...
export const VaultsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        vault: async (pubkey: string, height?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/mayachain/vault/{pubkey}`
                .replace(`{${"pubkey"}}`, encodeURIComponent(String(pubkey)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
