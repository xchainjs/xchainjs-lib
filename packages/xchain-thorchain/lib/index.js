...
var getTxsFromHistory = function (txs, mainAsset) {
    return txs.reduce(function (acc, tx) {
        ...
        if (tx.tx.body === undefined) {
            msgs = codec.codec.fromJSONString(codec.codec.toJSONString(tx.tx)).msg;
        }
        else {
            msgs = codec.codec.fromJSONString(codec.codec.toJSONString(tx.tx.body.messages));
        }
        var from = [];
        var to = [];
...
var sha256$2 = require('crypto-js/sha256');
...
var PubKeySecp256k1 = /** @class */ (function () {
    ...
    PubKeySecp256k1.prototype.hash160 = function (buffer) {
        var sha256Hash = crypto$3.createHash('sha256').update(buffer).digest();
        try {
            return crypto$3.createHash('rmd160').update(sha256Hash).digest();
        }
        catch (err) {
    ...
    PubKeySecp256k1.prototype.verify = function (signature, message) {
        var hash = crypto$3.createHash('sha256').update(message).digest();
        return secp256k1$2.verify(hash, signature, this.pubKey);
    };
...
var PrivKeySecp256k1 = /** @class */ (function () {
    function PrivKeySecp256k1(privKey) {
        this.pubKey = new PubKeySecp256k1(secp256k1$2.pointFromScalar(privKey));
    ...
    PrivKeySecp256k1.prototype.sign = function (message) {
        var hash = crypto$3.createHash('sha256').update(message).digest();
        var signature = secp256k1$2.sign(hash, this.privKey);
        return signature;
    };
...
var PubKeyEd25519 = /** @class */ (function () {
    ...
    PubKeyEd25519.prototype.getAddress = function () {
        var hash = crypto$1$1.createHash('sha256').update(this.pubKey).digest();
...
var Client = /** @class */ (function () {
    function Client(_a) {
        ...
        this.registerCodecs = function () {
            codec.codec.registerCodec('cosmos-sdk/MsgSend', bank.MsgSend, bank.MsgSend.fromJSON);
            codec.codec.registerCodec('cosmos-sdk/MsgMultiSend', bank.MsgMultiSend, bank.MsgMultiSend.fromJSON);
        };
...
var sha256$3 = require('crypto-js/sha256');
var ripemd160$3 = require('crypto-js/ripemd160');
var hexEncoding$1 = require('crypto-js/enc-hex');

// origin from https://github.com/cosmos-client/cosmos-client-ts/blob/master/src/tendermint/types/secp256k1.ts
var crypto$4 = require('crypto');
var secp256k1$3 = require('tiny-secp256k1');
var PubKeySecp256k1$1 = /** @class */ (function () {
    function PubKeySecp256k1(pubKey) {
        this.pubKey = pubKey;
    }
    PubKeySecp256k1.prototype.hash160 = function (buffer) {
        var sha256Hash = crypto$4.createHash('sha256').update(buffer).digest();
        try {
            return crypto$4.createHash('rmd160').update(sha256Hash).digest();
        }
        catch (err) {
            return crypto$4.createHash('ripemd160').update(sha256Hash).digest();
        }
    };
    PubKeySecp256k1.prototype.getAddress = function () {
        return this.hash160(this.pubKey);
    ...
    PubKeySecp256k1.prototype.verify = function (signature, message) {
        var hash = crypto$4.createHash('sha256').update(message).digest();
        return secp256k1$3.verify(hash, signature, this.pubKey);
    };
    PubKeySecp256k1.prototype.toBuffer = function () {
        return Buffer.from(this.pubKey);
    };
...
var PrivKeySecp256k1$1 = /** @class */ (function () {
    function PrivKeySecp256k1(privKey) {
        this.pubKey = new PubKeySecp256k1$1(secp256k1$3.pointFromScalar(privKey));
        this.privKey = privKey;
    }
    PrivKeySecp256k1.prototype.getPubKey = function () {
        return this.pubKey;
    ...
    PrivKeySecp256k1.prototype.sign = function (message) {
        var hash = crypto$4.createHash('sha256').update(message).digest();
        var signature = secp256k1$3.sign(hash, this.privKey);
        return signature;
    };
    PrivKeySecp256k1.prototype.toBuffer = function () {
        return Buffer.from(this.privKey);
...
// origin from https://github.com/cosmos-client/cosmos-client-ts/blob/master/src/tendermint/types/ed25519.ts
var crypto$1$2 = require('crypto');
var nacl$1 = require('tweetnacl');
var PubKeyEd25519$1 = /** @class */ (function () {
    function PubKeyEd25519(pubKey) {
        this.pubKey = pubKey;
    }
    PubKeyEd25519.prototype.getAddress = function () {
        var hash = crypto$1$2.createHash('sha256').update(this.pubKey).digest();
        return hash.subarray(0, 20);
    };
    PubKeyEd25519.prototype.verify = function (signature) {
        return nacl$1.sign.open(new Uint8Array(signature), new Uint8Array(this.pubKey)) !== null;
    };
    PubKeyEd25519.prototype.toBuffer = function () {
        return Buffer.from(this.pubKey);
    };
...
var PrivKeyEd25519$1 = /** @class */ (function () {
    function PrivKeyEd25519(privKey) {
        var keypair = nacl$1.sign.keyPair.fromSeed(new Uint8Array(privKey));
        this.pubKey = new PubKeyEd25519$1(Buffer.from(keypair.publicKey));
        this.privKey = privKey;
    }
    PrivKeyEd25519.prototype.getPubKey = function () {
        return this.pubKey;
    ...
    PrivKeyEd25519.prototype.sign = function (message) {
        var keypair = nacl$1.sign.keyPair.fromSeed(new Uint8Array(this.privKey));
        return Buffer.from(nacl$1.sign(new Uint8Array(message), new Uint8Array(keypair.secretKey)));
    };
    PrivKeyEd25519.prototype.toBuffer = function () {
        return Buffer.from(this.privKey);
    };
...
var Client$1 = /** @class */ (function () {
    function Client(_a) {
        ...
        this.registerCodecs = function () {
            codec.codec.registerCodec('thorchain/MsgSend', bank.MsgSend, bank.MsgSend.fromJSON);
            codec.codec.registerCodec('thorchain/MsgMultiSend', bank.MsgMultiSend, bank.MsgMultiSend.fromJSON);
        };
        this.getExplorerUrl = function () {
...
exports.getAsset = getAsset$1;
exports.getDenom = getDenom$1;
