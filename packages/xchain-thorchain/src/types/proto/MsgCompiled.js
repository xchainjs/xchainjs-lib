...
$root.common = (function() {
    ...
    common.QuorumState = (function() {
         ...
         * @property {Array.<common.IQuorumPriceFeed>|null} [quoPriceFeeds] QuorumState quoPriceFeeds
         */
        ...
        /**
         * QuorumState quoPriceFeeds.
         * @member {Array.<common.IQuorumPriceFeed>} quoPriceFeeds
         * @memberof common.QuorumState
         * @instance
         */
        QuorumState.prototype.quoPriceFeeds = $util.emptyArray;
        ...
        QuorumState.encode = function encode(message, writer) {
            ...
            if (message.quoPriceFeeds != null && message.quoPriceFeeds.length)
                for (var i = 0; i < message.quoPriceFeeds.length; ++i)
                    $root.common.QuorumPriceFeed.encode(message.quoPriceFeeds[i], writer.uint32(/* id 5, wireType 2 =*/42).fork()).ldelim();
            return writer;
        };
        ...
        QuorumState.decode = function decode(reader, length) {
            ...
            while (reader.pos < end) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    if (!(message.quoPriceFeeds && message.quoPriceFeeds.length))
                        message.quoPriceFeeds = [];
                    message.quoPriceFeeds.push($root.common.QuorumPriceFeed.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
        ...
        QuorumState.verify = function verify(message) {
            ...
            if (message.quoPriceFeeds != null && message.hasOwnProperty("quoPriceFeeds")) {
                if (!Array.isArray(message.quoPriceFeeds))
                    return "quoPriceFeeds: array expected";
                for (var i = 0; i < message.quoPriceFeeds.length; ++i) {
                    var error = $root.common.QuorumPriceFeed.verify(message.quoPriceFeeds[i]);
                    if (error)
                        return "quoPriceFeeds." + error;
                }
            }
            return null;
        };
        ...
        QuorumState.fromObject = function fromObject(object) {
            ...
            if (object.quoPriceFeeds) {
                if (!Array.isArray(object.quoPriceFeeds))
                    throw TypeError(".common.QuorumState.quoPriceFeeds: array expected");
                message.quoPriceFeeds = [];
                for (var i = 0; i < object.quoPriceFeeds.length; ++i) {
                    if (typeof object.quoPriceFeeds[i] !== "object")
                        throw TypeError(".common.QuorumState.quoPriceFeeds: object expected");
                    message.quoPriceFeeds[i] = $root.common.QuorumPriceFeed.fromObject(object.quoPriceFeeds[i]);
                }
            }
            return message;
        };
        ...
        QuorumState.toObject = function toObject(message, options) {
            ...
            if (message.quoPriceFeeds && message.quoPriceFeeds.length) {
                object.quoPriceFeeds = [];
                for (var j = 0; j < message.quoPriceFeeds.length; ++j)
                    object.quoPriceFeeds[j] = $root.common.QuorumPriceFeed.toObject(message.quoPriceFeeds[j], options);
            }
            return object;
        };
    ...
    common.PriceFeed = (function() {

        /**
         * Properties of a PriceFeed.
         * @memberof common
         * @interface IPriceFeed
         * @property {Uint8Array|null} [version] PriceFeed version
         * @property {number|Long|null} [time] PriceFeed time
         * @property {Array.<common.IOraclePrice>|null} [rates] PriceFeed rates
         */

        /**
         * Constructs a new PriceFeed.
         * @memberof common
         * @classdesc Represents a PriceFeed.
         * @implements IPriceFeed
         * @constructor
         * @param {common.IPriceFeed=} [properties] Properties to set
         */
        function PriceFeed(properties) {
            this.rates = [];
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
         ...
         * @memberof common.PriceFeed
         * @instance
         */
        PriceFeed.prototype.version = $util.newBuffer([]);
         ...
         * @instance
         */
        PriceFeed.prototype.time = $util.Long ? $util.Long.fromBits(0,0,false) : 0;

        /**
         * PriceFeed rates.
         * @member {Array.<common.IOraclePrice>} rates
         * @memberof common.PriceFeed
         * @instance
         */
        PriceFeed.prototype.rates = $util.emptyArray;

        /**
         * Creates a new PriceFeed instance using the specified properties.
         * @function create
         * @memberof common.PriceFeed
         * @static
         * @param {common.IPriceFeed=} [properties] Properties to set
         * @returns {common.PriceFeed} PriceFeed instance
         */
        PriceFeed.create = function create(properties) {
            return new PriceFeed(properties);
        };

        /**
         * Encodes the specified PriceFeed message. Does not implicitly {@link common.PriceFeed.verify|verify} messages.
         * @function encode
         * @memberof common.PriceFeed
         * @static
         * @param {common.IPriceFeed} message PriceFeed message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        PriceFeed.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            ...
            if (message.rates != null && message.rates.length)
                for (var i = 0; i < message.rates.length; ++i)
                    $root.common.OraclePrice.encode(message.rates[i], writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
            return writer;
        };

        /**
         * Encodes the specified PriceFeed message, length delimited. Does not implicitly {@link common.PriceFeed.verify|verify} messages.
         * @function encodeDelimited
         * @memberof common.PriceFeed
         * @static
         * @param {common.IPriceFeed} message PriceFeed message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        PriceFeed.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a PriceFeed message from the specified reader or buffer.
         * @function decode
         * @memberof common.PriceFeed
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {common.PriceFeed} PriceFeed
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        PriceFeed.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.common.PriceFeed();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
                ...
                case 3:
                    if (!(message.rates && message.rates.length))
                        message.rates = [];
                    message.rates.push($root.common.OraclePrice.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
        ...
        /**
         * Decodes a PriceFeed message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof common.PriceFeed
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        PriceFeed.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        PriceFeed.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            ...
            if (message.rates != null && message.hasOwnProperty("rates")) {
                ...
                for (var i = 0; i < message.rates.length; ++i) {
                    var error = $root.common.OraclePrice.verify(message.rates[i]);
                    if (error)
                        return "rates." + error;
                }
            }
        ...
        /**
         * Creates a PriceFeed message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof common.PriceFeed
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {common.PriceFeed} PriceFeed
         */
        PriceFeed.fromObject = function fromObject(object) {
            if (object instanceof $root.common.PriceFeed)
                return object;
            var message = new $root.common.PriceFeed();
            ...
            if (object.rates) {
                if (!Array.isArray(object.rates))
                    throw TypeError(".common.PriceFeed.rates: array expected");
                message.rates = [];
                for (var i = 0; i < object.rates.length; ++i) {
                    if (typeof object.rates[i] !== "object")
                        throw TypeError(".common.PriceFeed.rates: object expected");
                    message.rates[i] = $root.common.OraclePrice.fromObject(object.rates[i]);
                }
            }
            return message;
        };
        ...
        /**
         * Creates a plain object from a PriceFeed message. Also converts values to other types if specified.
         * @function toObject
         * @memberof common.PriceFeed
         * @static
         * @param {common.PriceFeed} message PriceFeed
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        PriceFeed.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.arrays || options.defaults)
            ...
            if (message.rates && message.rates.length) {
                ...
                for (var j = 0; j < message.rates.length; ++j)
                    object.rates[j] = $root.common.OraclePrice.toObject(message.rates[j], options);
            }
            return object;
        };

        /**
         * Converts this PriceFeed to JSON.
         * @function toJSON
         * @memberof common.PriceFeed
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        PriceFeed.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    common.AttestPriceFeed = (function() {

        /**
         * Properties of an AttestPriceFeed.
         * @memberof common
         * @interface IAttestPriceFeed
         * @property {common.IPriceFeed|null} [priceFeed] AttestPriceFeed priceFeed
         * @property {common.IAttestation|null} [attestation] AttestPriceFeed attestation
         */

        /**
         * Constructs a new AttestPriceFeed.
         * @memberof common
         * @classdesc Represents an AttestPriceFeed.
         * @implements IAttestPriceFeed
         * @constructor
         * @param {common.IAttestPriceFeed=} [properties] Properties to set
         */
        function AttestPriceFeed(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
        ...
        /**
         * AttestPriceFeed priceFeed.
         * @member {common.IPriceFeed|null|undefined} priceFeed
         * @memberof common.AttestPriceFeed
         * @instance
         */
        AttestPriceFeed.prototype.priceFeed = null;

        /**
         * AttestPriceFeed attestation.
         * @member {common.IAttestation|null|undefined} attestation
         * @memberof common.AttestPriceFeed
         * @instance
         */
        AttestPriceFeed.prototype.attestation = null;

        /**
         * Creates a new AttestPriceFeed instance using the specified properties.
         * @function create
         * @memberof common.AttestPriceFeed
         * @static
         * @param {common.IAttestPriceFeed=} [properties] Properties to set
         * @returns {common.AttestPriceFeed} AttestPriceFeed instance
         */
        AttestPriceFeed.create = function create(properties) {
            return new AttestPriceFeed(properties);
        };

        /**
         * Encodes the specified AttestPriceFeed message. Does not implicitly {@link common.AttestPriceFeed.verify|verify} messages.
         * @function encode
         * @memberof common.AttestPriceFeed
         * @static
         * @param {common.IAttestPriceFeed} message AttestPriceFeed message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        AttestPriceFeed.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.priceFeed != null && Object.hasOwnProperty.call(message, "priceFeed"))
                $root.common.PriceFeed.encode(message.priceFeed, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            if (message.attestation != null && Object.hasOwnProperty.call(message, "attestation"))
                $root.common.Attestation.encode(message.attestation, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
            return writer;
        };
        ...
        /**
         * Encodes the specified AttestPriceFeed message, length delimited. Does not implicitly {@link common.AttestPriceFeed.verify|verify} messages.
         * @function encodeDelimited
         * @memberof common.AttestPriceFeed
         * @static
         * @param {common.IAttestPriceFeed} message AttestPriceFeed message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        AttestPriceFeed.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes an AttestPriceFeed message from the specified reader or buffer.
         * @function decode
         * @memberof common.AttestPriceFeed
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {common.AttestPriceFeed} AttestPriceFeed
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        AttestPriceFeed.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.common.AttestPriceFeed();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
                    message.priceFeed = $root.common.PriceFeed.decode(reader, reader.uint32());
                    break;
                case 2:
                    message.attestation = $root.common.Attestation.decode(reader, reader.uint32());
                    break;
        ...
        /**
         * Decodes an AttestPriceFeed message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof common.AttestPriceFeed
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        AttestPriceFeed.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies an AttestPriceFeed message.
         * @function verify
         * @memberof common.AttestPriceFeed
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        AttestPriceFeed.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.priceFeed != null && message.hasOwnProperty("priceFeed")) {
                var error = $root.common.PriceFeed.verify(message.priceFeed);
                if (error)
                    return "priceFeed." + error;
            }
            if (message.attestation != null && message.hasOwnProperty("attestation")) {
                var error = $root.common.Attestation.verify(message.attestation);
                if (error)
        ...
        /**
         * Creates an AttestPriceFeed message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof common.AttestPriceFeed
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {common.AttestPriceFeed} AttestPriceFeed
         */
        AttestPriceFeed.fromObject = function fromObject(object) {
            if (object instanceof $root.common.AttestPriceFeed)
                return object;
            var message = new $root.common.AttestPriceFeed();
            if (object.priceFeed != null) {
                if (typeof object.priceFeed !== "object")
                    throw TypeError(".common.AttestPriceFeed.priceFeed: object expected");
                message.priceFeed = $root.common.PriceFeed.fromObject(object.priceFeed);
            }
            if (object.attestation != null) {
                if (typeof object.attestation !== "object")
                    throw TypeError(".common.AttestPriceFeed.attestation: object expected");
                message.attestation = $root.common.Attestation.fromObject(object.attestation);
            }
            return message;
        };
        ...
        /**
         * Creates a plain object from an AttestPriceFeed message. Also converts values to other types if specified.
         * @function toObject
         * @memberof common.AttestPriceFeed
         * @static
         * @param {common.AttestPriceFeed} message AttestPriceFeed
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        AttestPriceFeed.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
                object.priceFeed = null;
                object.attestation = null;
            }
            if (message.priceFeed != null && message.hasOwnProperty("priceFeed"))
                object.priceFeed = $root.common.PriceFeed.toObject(message.priceFeed, options);
            if (message.attestation != null && message.hasOwnProperty("attestation"))
                object.attestation = $root.common.Attestation.toObject(message.attestation, options);
            return object;
        };
        ...
        /**
         * Converts this AttestPriceFeed to JSON.
         * @function toJSON
         * @memberof common.AttestPriceFeed
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        AttestPriceFeed.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };

        return AttestPriceFeed;
    })();

    common.QuorumPriceFeed = (function() {

        /**
         * Properties of a QuorumPriceFeed.
         * @memberof common
         * @interface IQuorumPriceFeed
         * @property {common.IPriceFeed|null} [priceFeed] QuorumPriceFeed priceFeed
         * @property {Array.<common.IAttestation>|null} [attestations] QuorumPriceFeed attestations
         */

        /**
         * Constructs a new QuorumPriceFeed.
         * @memberof common
         * @classdesc Represents a QuorumPriceFeed.
         * @implements IQuorumPriceFeed
         * @constructor
         * @param {common.IQuorumPriceFeed=} [properties] Properties to set
         */
        function QuorumPriceFeed(properties) {
            this.attestations = [];
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
        ...
        /**
         * QuorumPriceFeed priceFeed.
         * @member {common.IPriceFeed|null|undefined} priceFeed
         * @memberof common.QuorumPriceFeed
         * @instance
         */
        QuorumPriceFeed.prototype.priceFeed = null;

        /**
         * QuorumPriceFeed attestations.
         * @member {Array.<common.IAttestation>} attestations
         * @memberof common.QuorumPriceFeed
         * @instance
         */
        QuorumPriceFeed.prototype.attestations = $util.emptyArray;

        /**
         * Creates a new QuorumPriceFeed instance using the specified properties.
         * @function create
         * @memberof common.QuorumPriceFeed
         * @static
         * @param {common.IQuorumPriceFeed=} [properties] Properties to set
         * @returns {common.QuorumPriceFeed} QuorumPriceFeed instance
         */
        QuorumPriceFeed.create = function create(properties) {
            return new QuorumPriceFeed(properties);
        };

        /**
         * Encodes the specified QuorumPriceFeed message. Does not implicitly {@link common.QuorumPriceFeed.verify|verify} messages.
         * @function encode
         * @memberof common.QuorumPriceFeed
         * @static
         * @param {common.IQuorumPriceFeed} message QuorumPriceFeed message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        QuorumPriceFeed.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.priceFeed != null && Object.hasOwnProperty.call(message, "priceFeed"))
                $root.common.PriceFeed.encode(message.priceFeed, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
        ...
        /**
         * Encodes the specified QuorumPriceFeed message, length delimited. Does not implicitly {@link common.QuorumPriceFeed.verify|verify} messages.
         * @function encodeDelimited
         * @memberof common.QuorumPriceFeed
         * @static
         * @param {common.IQuorumPriceFeed} message QuorumPriceFeed message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        QuorumPriceFeed.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a QuorumPriceFeed message from the specified reader or buffer.
         * @function decode
         * @memberof common.QuorumPriceFeed
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {common.QuorumPriceFeed} QuorumPriceFeed
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        QuorumPriceFeed.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.common.QuorumPriceFeed();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        /**
         * Decodes a QuorumPriceFeed message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof common.QuorumPriceFeed
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        QuorumPriceFeed.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a QuorumPriceFeed message.
         * @function verify
         * @memberof common.QuorumPriceFeed
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        QuorumPriceFeed.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.priceFeed != null && message.hasOwnProperty("priceFeed")) {
                var error = $root.common.PriceFeed.verify(message.priceFeed);
        ...
        /**
         * Creates a QuorumPriceFeed message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof common.QuorumPriceFeed
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {common.QuorumPriceFeed} QuorumPriceFeed
         */
        QuorumPriceFeed.fromObject = function fromObject(object) {
            if (object instanceof $root.common.QuorumPriceFeed)
                return object;
            var message = new $root.common.QuorumPriceFeed();
            if (object.priceFeed != null) {
                if (typeof object.priceFeed !== "object")
                    throw TypeError(".common.QuorumPriceFeed.priceFeed: object expected");
                message.priceFeed = $root.common.PriceFeed.fromObject(object.priceFeed);
            }
            if (object.attestations) {
                if (!Array.isArray(object.attestations))
                    throw TypeError(".common.QuorumPriceFeed.attestations: array expected");
                message.attestations = [];
                for (var i = 0; i < object.attestations.length; ++i) {
                    if (typeof object.attestations[i] !== "object")
                        throw TypeError(".common.QuorumPriceFeed.attestations: object expected");
                    message.attestations[i] = $root.common.Attestation.fromObject(object.attestations[i]);
                }
            }
            return message;
        ...
        /**
         * Creates a plain object from a QuorumPriceFeed message. Also converts values to other types if specified.
         * @function toObject
         * @memberof common.QuorumPriceFeed
         * @static
         * @param {common.QuorumPriceFeed} message QuorumPriceFeed
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        QuorumPriceFeed.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.arrays || options.defaults)
        ...
        /**
         * Converts this QuorumPriceFeed to JSON.
         * @function toJSON
         * @memberof common.QuorumPriceFeed
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        QuorumPriceFeed.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    common.QuorumPriceFeedBatch = (function() {

        /**
         * Properties of a QuorumPriceFeedBatch.
         * @memberof common
         * @interface IQuorumPriceFeedBatch
         * @property {Array.<common.IQuorumPriceFeed>|null} [quorumPriceFeeds] QuorumPriceFeedBatch quorumPriceFeeds
         */

        /**
         * Constructs a new QuorumPriceFeedBatch.
         * @memberof common
         * @classdesc Represents a QuorumPriceFeedBatch.
         * @implements IQuorumPriceFeedBatch
         * @constructor
         * @param {common.IQuorumPriceFeedBatch=} [properties] Properties to set
         */
        function QuorumPriceFeedBatch(properties) {
            this.quorumPriceFeeds = [];
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
        ...
        /**
         * QuorumPriceFeedBatch quorumPriceFeeds.
         * @member {Array.<common.IQuorumPriceFeed>} quorumPriceFeeds
         * @memberof common.QuorumPriceFeedBatch
         * @instance
         */
        QuorumPriceFeedBatch.prototype.quorumPriceFeeds = $util.emptyArray;

        /**
         * Creates a new QuorumPriceFeedBatch instance using the specified properties.
         * @function create
         * @memberof common.QuorumPriceFeedBatch
         * @static
         * @param {common.IQuorumPriceFeedBatch=} [properties] Properties to set
         * @returns {common.QuorumPriceFeedBatch} QuorumPriceFeedBatch instance
         */
        QuorumPriceFeedBatch.create = function create(properties) {
            return new QuorumPriceFeedBatch(properties);
        };

        /**
         * Encodes the specified QuorumPriceFeedBatch message. Does not implicitly {@link common.QuorumPriceFeedBatch.verify|verify} messages.
         * @function encode
         * @memberof common.QuorumPriceFeedBatch
         * @static
         * @param {common.IQuorumPriceFeedBatch} message QuorumPriceFeedBatch message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        QuorumPriceFeedBatch.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.quorumPriceFeeds != null && message.quorumPriceFeeds.length)
                for (var i = 0; i < message.quorumPriceFeeds.length; ++i)
                    $root.common.QuorumPriceFeed.encode(message.quorumPriceFeeds[i], writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            return writer;
        };

        /**
         * Encodes the specified QuorumPriceFeedBatch message, length delimited. Does not implicitly {@link common.QuorumPriceFeedBatch.verify|verify} messages.
         * @function encodeDelimited
         * @memberof common.QuorumPriceFeedBatch
         * @static
         * @param {common.IQuorumPriceFeedBatch} message QuorumPriceFeedBatch message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        QuorumPriceFeedBatch.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a QuorumPriceFeedBatch message from the specified reader or buffer.
         * @function decode
         * @memberof common.QuorumPriceFeedBatch
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {common.QuorumPriceFeedBatch} QuorumPriceFeedBatch
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        QuorumPriceFeedBatch.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.common.QuorumPriceFeedBatch();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
                    if (!(message.quorumPriceFeeds && message.quorumPriceFeeds.length))
                        message.quorumPriceFeeds = [];
                    message.quorumPriceFeeds.push($root.common.QuorumPriceFeed.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
        ...
        /**
         * Decodes a QuorumPriceFeedBatch message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof common.QuorumPriceFeedBatch
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        QuorumPriceFeedBatch.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a QuorumPriceFeedBatch message.
         * @function verify
         * @memberof common.QuorumPriceFeedBatch
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        QuorumPriceFeedBatch.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.quorumPriceFeeds != null && message.hasOwnProperty("quorumPriceFeeds")) {
                if (!Array.isArray(message.quorumPriceFeeds))
                    return "quorumPriceFeeds: array expected";
                for (var i = 0; i < message.quorumPriceFeeds.length; ++i) {
                    var error = $root.common.QuorumPriceFeed.verify(message.quorumPriceFeeds[i]);
                    if (error)
                        return "quorumPriceFeeds." + error;
                }
            }
            return null;
        };
        ...
        /**
         * Creates a QuorumPriceFeedBatch message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof common.QuorumPriceFeedBatch
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {common.QuorumPriceFeedBatch} QuorumPriceFeedBatch
         */
        QuorumPriceFeedBatch.fromObject = function fromObject(object) {
            if (object instanceof $root.common.QuorumPriceFeedBatch)
                return object;
            var message = new $root.common.QuorumPriceFeedBatch();
            if (object.quorumPriceFeeds) {
                if (!Array.isArray(object.quorumPriceFeeds))
                    throw TypeError(".common.QuorumPriceFeedBatch.quorumPriceFeeds: array expected");
                message.quorumPriceFeeds = [];
                for (var i = 0; i < object.quorumPriceFeeds.length; ++i) {
                    if (typeof object.quorumPriceFeeds[i] !== "object")
                        throw TypeError(".common.QuorumPriceFeedBatch.quorumPriceFeeds: object expected");
                    message.quorumPriceFeeds[i] = $root.common.QuorumPriceFeed.fromObject(object.quorumPriceFeeds[i]);
                }
            }
            return message;
        };
        ...
        /**
         * Creates a plain object from a QuorumPriceFeedBatch message. Also converts values to other types if specified.
         * @function toObject
         * @memberof common.QuorumPriceFeedBatch
         * @static
         * @param {common.QuorumPriceFeedBatch} message QuorumPriceFeedBatch
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        QuorumPriceFeedBatch.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.arrays || options.defaults)
                object.quorumPriceFeeds = [];
            if (message.quorumPriceFeeds && message.quorumPriceFeeds.length) {
                object.quorumPriceFeeds = [];
                for (var j = 0; j < message.quorumPriceFeeds.length; ++j)
                    object.quorumPriceFeeds[j] = $root.common.QuorumPriceFeed.toObject(message.quorumPriceFeeds[j], options);
            }
            return object;
        };

        /**
         * Converts this QuorumPriceFeedBatch to JSON.
         * @function toJSON
         * @memberof common.QuorumPriceFeedBatch
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        QuorumPriceFeedBatch.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    common.OraclePrice = (function() {

        /**
         * Properties of an OraclePrice.
         * @memberof common
         * @interface IOraclePrice
         * @property {number|Long|null} [amount] OraclePrice amount
         * @property {number|null} [decimals] OraclePrice decimals
         */

        /**
         * Constructs a new OraclePrice.
         * @memberof common
         * @classdesc Represents an OraclePrice.
         * @implements IOraclePrice
         * @constructor
         * @param {common.IOraclePrice=} [properties] Properties to set
         */
        function OraclePrice(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
         ...
         * @memberof common.OraclePrice
         * @instance
         */
        OraclePrice.prototype.amount = $util.Long ? $util.Long.fromBits(0,0,true) : 0;
         ...
         * @instance
         */
        OraclePrice.prototype.decimals = 0;

        /**
         * Creates a new OraclePrice instance using the specified properties.
         * @function create
         * @memberof common.OraclePrice
         * @static
         * @param {common.IOraclePrice=} [properties] Properties to set
         * @returns {common.OraclePrice} OraclePrice instance
         */
        OraclePrice.create = function create(properties) {
            return new OraclePrice(properties);
        };

        /**
         * Encodes the specified OraclePrice message. Does not implicitly {@link common.OraclePrice.verify|verify} messages.
         * @function encode
         * @memberof common.OraclePrice
         * @static
         * @param {common.IOraclePrice} message OraclePrice message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        OraclePrice.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.amount != null && Object.hasOwnProperty.call(message, "amount"))
        ...
        /**
         * Encodes the specified OraclePrice message, length delimited. Does not implicitly {@link common.OraclePrice.verify|verify} messages.
         * @function encodeDelimited
         * @memberof common.OraclePrice
         * @static
         * @param {common.IOraclePrice} message OraclePrice message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        OraclePrice.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes an OraclePrice message from the specified reader or buffer.
         * @function decode
         * @memberof common.OraclePrice
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {common.OraclePrice} OraclePrice
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        OraclePrice.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.common.OraclePrice();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        /**
         * Decodes an OraclePrice message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof common.OraclePrice
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        OraclePrice.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies an OraclePrice message.
         * @function verify
         * @memberof common.OraclePrice
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        OraclePrice.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.amount != null && message.hasOwnProperty("amount"))
        ...
        /**
         * Creates an OraclePrice message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof common.OraclePrice
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {common.OraclePrice} OraclePrice
         */
        OraclePrice.fromObject = function fromObject(object) {
            if (object instanceof $root.common.OraclePrice)
                return object;
            var message = new $root.common.OraclePrice();
            if (object.amount != null)
                if ($util.Long)
        ...
        /**
         * Creates a plain object from an OraclePrice message. Also converts values to other types if specified.
         * @function toObject
         * @memberof common.OraclePrice
         * @static
         * @param {common.OraclePrice} message OraclePrice
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        OraclePrice.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
        ...
        /**
         * Converts this OraclePrice to JSON.
         * @function toJSON
         * @memberof common.OraclePrice
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        OraclePrice.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    common.AttestationBatch = (function() {
         ...
         * @property {Array.<common.IAttestPriceFeed>|null} [attestPriceFeeds] AttestationBatch attestPriceFeeds
         */
        ...
        /**
         * AttestationBatch attestPriceFeeds.
         * @member {Array.<common.IAttestPriceFeed>} attestPriceFeeds
         * @memberof common.AttestationBatch
         * @instance
         */
        AttestationBatch.prototype.attestPriceFeeds = $util.emptyArray;
        ...
        AttestationBatch.encode = function encode(message, writer) {
            ...
            if (message.attestPriceFeeds != null && message.attestPriceFeeds.length)
                for (var i = 0; i < message.attestPriceFeeds.length; ++i)
                    $root.common.AttestPriceFeed.encode(message.attestPriceFeeds[i], writer.uint32(/* id 5, wireType 2 =*/42).fork()).ldelim();
            return writer;
        };
        ...
        AttestationBatch.decode = function decode(reader, length) {
            ...
            while (reader.pos < end) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    if (!(message.attestPriceFeeds && message.attestPriceFeeds.length))
                        message.attestPriceFeeds = [];
                    message.attestPriceFeeds.push($root.common.AttestPriceFeed.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
        ...
        AttestationBatch.verify = function verify(message) {
            ...
            if (message.attestPriceFeeds != null && message.hasOwnProperty("attestPriceFeeds")) {
                if (!Array.isArray(message.attestPriceFeeds))
                    return "attestPriceFeeds: array expected";
                for (var i = 0; i < message.attestPriceFeeds.length; ++i) {
                    var error = $root.common.AttestPriceFeed.verify(message.attestPriceFeeds[i]);
                    if (error)
                        return "attestPriceFeeds." + error;
                }
            }
            return null;
        };
        ...
        AttestationBatch.fromObject = function fromObject(object) {
            ...
            if (object.attestPriceFeeds) {
                if (!Array.isArray(object.attestPriceFeeds))
                    throw TypeError(".common.AttestationBatch.attestPriceFeeds: array expected");
                message.attestPriceFeeds = [];
                for (var i = 0; i < object.attestPriceFeeds.length; ++i) {
                    if (typeof object.attestPriceFeeds[i] !== "object")
                        throw TypeError(".common.AttestationBatch.attestPriceFeeds: object expected");
                    message.attestPriceFeeds[i] = $root.common.AttestPriceFeed.fromObject(object.attestPriceFeeds[i]);
                }
            }
            return message;
        };
        ...
        AttestationBatch.toObject = function toObject(message, options) {
            ...
            if (message.attestPriceFeeds && message.attestPriceFeeds.length) {
                object.attestPriceFeeds = [];
                for (var j = 0; j < message.attestPriceFeeds.length; ++j)
                    object.attestPriceFeeds[j] = $root.common.AttestPriceFeed.toObject(message.attestPriceFeeds[j], options);
            }
            return object;
        };
