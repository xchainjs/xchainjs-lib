...
var Client = /** @class */ (function () {
    ...
    function Client(phrase, network) {
        ...
        this.getFees = function () { return __awaiter(_this, void 0, void 0, function () {
            var clientUrl, url, response, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        clientUrl = this.getClientUrl() + "/api/v1/fees";
                        url = new URL(clientUrl);
                        return [4 /*yield*/, this.bncClient.initChain()];
                    case 1:
                        _a.sent();
...
export { Client, OrderStatus, binanceWs as WS, getHashFromTransfer, getTxHashFromMemo };
