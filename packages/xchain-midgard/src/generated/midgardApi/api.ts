...
export const DefaultApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @param {string} [affiliate] Affiliate address of the action (swap, refund)
    ...
    getBalance: async (
      ...
      const localVarPath = `/v2/balance/{address}`.replace(`{${'address'}}`, encodeURIComponent(String(address)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
      if (configuration) {
    ...
    getPool: async (
      asset: string,
      period?: '1h' | '24h' | '7d' | '30d' | '90d' | '100d' | '180d' | '365d' | 'all',
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
    ...
    getSaverDetail: async (address: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/v2/saver/{address}`.replace(`{${'address'}}`, encodeURIComponent(String(address)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
      if (configuration) {
    ...
    getSaversHistory: async (
      ...
      const localVarPath = `/v2/history/savers/{pool}`.replace(`{${'pool'}}`, encodeURIComponent(String(pool)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
      if (configuration) {
    ...
    getTHORNameDetail: async (name: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/v2/thorname/lookup/{name}`.replace(`{${'name'}}`, encodeURIComponent(String(name)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
      if (configuration) {
    ...
    getTHORNamesOwnerByAddress: async (address: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/v2/thorname/owner/{address}`.replace(`{${'address'}}`, encodeURIComponent(String(address)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
      if (configuration) {
...
export const DefaultApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async getActions(
      ...
      offset?: number,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetActions200Response>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getActions(
        address,
        txid,
        asset,
        type,
    ...
    async getChurns(
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Churns>> {
    ...
    async getDepthHistory(
      ...
      from?: number,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DepthHistory>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getDepthHistory(
        pool,
        interval,
        count,
        to,
    ...
    async getEarningsHistory(
      ...
      from?: number,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EarningsHistory>> {
    ...
    async getKnownPools(
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<KnownPools>> {
    ...
    async getLiquidityHistory(
      ...
      from?: number,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LiquidityHistory>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getLiquidityHistory(
        pool,
        interval,
        count,
        to,
    ...
    async getMemberDetail(
      ...
      showSavers?: boolean,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<MemberDetails>> {
    ...
    async getMembersAdresses(
      pool?: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Members>> {
    ...
    async getPool(
      ...
      period?: '1h' | '24h' | '7d' | '30d' | '90d' | '100d' | '180d' | '365d' | 'all',
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PoolDetail>> {
    ...
    async getPoolStats(
      ...
      period?: '1h' | '24h' | '7d' | '30d' | '90d' | '100d' | '180d' | '365d' | 'all',
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PoolStatsDetail>> {
    ...
    async getPools(
      ...
      period?: '1h' | '24h' | '7d' | '30d' | '90d' | '100d' | '180d' | '365d' | 'all',
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PoolDetails>> {
     ...
     * @throws {RequiredError}
     */
    async getSaverDetail(
      address: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SaverDetails>> {
    ...
    async getSaversHistory(
      ...
      from?: number,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SaversHistory>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getSaversHistory(
        pool,
        interval,
        count,
        to,
    ...
    async getStats(
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<StatsData>> {
    ...
    async getSwapHistory(
      ...
      from?: number,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SwapHistory>> {
    ...
    async getTHORNameDetail(
      name: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<THORNameDetails>> {
    ...
    async getTHORNamesByAddress(
      address: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ReverseTHORNames>> {
     ...
     * @throws {RequiredError}
     */
    async getTHORNamesOwnerByAddress(
      address: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ReverseTHORNames>> {
    ...
    async getTVLHistory(
      ...
      from?: number,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TVLHistory>> {
...
export const DefaultApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
    ...
    getActions(
      ...
      offset?: number,
      options?: any,
    ): AxiosPromise<GetActions200Response> {
      return localVarFp
    ...
    getSaversHistory(
      ...
      from?: number,
      options?: any,
    ): AxiosPromise<SaversHistory> {
      return localVarFp
        .getSaversHistory(pool, interval, count, to, from, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Returns an object containing global stats for all pools and all transactions
...
export class DefaultApi extends BaseAPI {
  ...
  public getMemberDetail(address: string, showSavers?: boolean, options?: AxiosRequestConfig) {
    return DefaultApiFp(this.configuration)
      .getMemberDetail(address, showSavers, options)
      .then((request) => request(this.axios, this.basePath))
  }
  ...
  public getSaverDetail(address: string, options?: AxiosRequestConfig) {
    return DefaultApiFp(this.configuration)
      .getSaverDetail(address, options)
      .then((request) => request(this.axios, this.basePath))
  }
