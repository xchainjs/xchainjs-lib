...
export interface PoolDetail {
    /**
     * Float, Also called APR. Annual return estimated from last 30 days income (linearly, not compounded). E.g. 0.1 means 10% yearly return. Due to Impermantent Loss and Synths this might be negative, but given Impermanent Loss Protection for 100+ day members, frontends might show MAX(APR, 0). 
     * @type {string}
     * @memberof PoolDetail
     */
...
export interface PoolStatsDetail {
    ...
    'addRuneLiquidityVolume': string;
    /**
     * Float, Also called APR. Estimated annual return (linearly, not compounded). Always estimated from last 30 days (doesn\'t take period into account). E.g. 0.1 means 10% yearly return. Due to Impermantent Loss and Synths this might be negative, but given Impermanent Loss Protection for 100+ day members, frontends might show MAX(APR, 0). 
     * @type {string}
     * @memberof PoolStatsDetail
     */
    'annualPercentageRate': string;
...
export const DefaultApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        /**
         * Returns all coin amounts for the given address at watermark height. This endpoint is enabled only if the midgard startup config allows it. 
         * @summary Current balance for an address
         * @param {string} address Rune address.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getBalance: async (address: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const DefaultApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getBalance(address: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Balance>> {
         ...
         * @throws {RequiredError}
         */
        async getPools(status?: 'available' | 'staged' | 'suspended', period?: '1h' | '24h' | '7d' | '30d' | '90d' | '100d' | '180d' | '365d' | 'all', options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<PoolDetail>>> {
         ...
         * @throws {RequiredError}
         */
        async getTHORNamesOwnerByAddress(address: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<string>>> {
...
export const DefaultApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getPools(status?: 'available' | 'staged' | 'suspended', period?: '1h' | '24h' | '7d' | '30d' | '90d' | '100d' | '180d' | '365d' | 'all', options?: any): AxiosPromise<Array<PoolDetail>> {
         ...
         * @throws {RequiredError}
         */
        getTHORNamesOwnerByAddress(address: string, options?: any): AxiosPromise<Array<string>> {
...
export class DefaultApi extends BaseAPI {
     ...
     * @memberof DefaultApi
     */
    public getBalance(address: string, options?: AxiosRequestConfig) {
        return DefaultApiFp(this.configuration).getBalance(address, options).then((request) => request(this.axios, this.basePath));
    }
