...
export const ActionTypeEnum = {
    ...
    Thorname: 'thorname',
    Send: 'send',
    CacaoPoolDeposit: 'cacaoPoolDeposit',
    CacaoPoolWithdraw: 'cacaoPoolWithdraw'
} as const;
...
export interface AffiliateHistoryItem {
    ...
    /**
     * 
     * @type {Array<ItemMayaname>}
     * @memberof AffiliateHistoryItem
     */
    'mayanames': Array<ItemMayaname>;
    /**
    ...
    'startTime': string;
    /**
     * Int64(e8), The total volume of the affiliates detonated in CACAO 
     * @type {string}
     * @memberof AffiliateHistoryItem
     */
    'volume': string;
    /**
     * Int64(e2), The total volume of the affiliates denoted in USD price of the cacao in each swap 
     * @type {string}
     * @memberof AffiliateHistoryItem
     */
    'volumeUSD': string;
...
export interface AffiliateHistoryMeta {
    ...
    'volume': string;
    /**
     * Int64(e2), The total volume of the affiliates denoted in USD price of the rune in each swap 
     * @type {string}
     * @memberof AffiliateHistoryMeta
     */
    'volumeUSD': string;
...
/**
 * List details of all the CACAOPoolPools identified with the given addresses
 * @export
 * @interface CACAOPoolDetails
 */
export interface CACAOPoolDetails extends Array<CACAOPoolProvider> {
}
/**
 * 
 * @export
 * @interface CACAOPoolHistory
 */
export interface CACAOPoolHistory {
    /**
     * 
     * @type {CACAOPoolHistoryIntervals}
     * @memberof CACAOPoolHistory
     */
 ...
 * 
 * @export
 * @interface CACAOPoolHistoryIntervals
 */
export interface CACAOPoolHistoryIntervals extends Array<CACAOPoolHistoryItem> {
}
/**
 * 
 * @export
 * @interface CACAOPoolHistoryItem
 */
export interface CACAOPoolHistoryItem {
    /**
     * Int64, Number of CACAOPool members in the pool at the end of the interval
     * @type {string}
     * @memberof CACAOPoolHistoryItem
     */
    'count': string;
    /**
     * Int64(e8), The depth in the CACAOPool vault at the end of the interval
     * @type {string}
     * @memberof CACAOPoolHistoryItem
     */
    'depth'?: string;
    ...
    'startTime': string;
    /**
     * Int64, Units in the CACAOPool vault at the end of the interval 
     * @type {string}
     * @memberof CACAOPoolHistoryItem
     */
    'units': string;
 ...
 * 
 * @export
 * @interface CACAOPoolHistoryMeta
 */
export interface CACAOPoolHistoryMeta {
    /**
     * Int64, Number of CACAOPool member in the CACAOPool vault at the end of the interval at time endTime
     * @type {string}
     * @memberof CACAOPoolHistoryMeta
     */
    'endCount': string;
    /**
     * Int64, The end time of bucket in unix timestamp
    ...
    'endTime': string;
    /**
     * Int64,  Units in the CACAOPool vault at the end of the interval at time endTime
     * @type {string}
     * @memberof CACAOPoolHistoryMeta
     */
    'endUnits': string;
    /**
     * Int64, Number of CACAOPool member in the CACAOPool vault at the start of the interval at time startTime 
     * @type {string}
     * @memberof CACAOPoolHistoryMeta
     */
    'startCount': string;
    ...
    'startTime': string;
    /**
     * Int64,  Units in the CACAOPool vault at the start of the interval at time startTime 
     * @type {string}
     * @memberof CACAOPoolHistoryMeta
     */
    'startUnits': string;
 ...
 * 
 * @export
 * @interface CACAOPoolProvider
 */
export interface CACAOPoolProvider {
    /**
     * Int64(e8), total asset added in the CACAOPool by member
     * @type {string}
     * @memberof CACAOPoolProvider
     */
    'cacaoAdded': string;
    /**
    ...
    'cacaoDeposit': string;
    /**
     * Int64(e8), total asset withdrawn from the CACAOPool by the member
     * @type {string}
     * @memberof CACAOPoolProvider
     */
    'cacaoWithdrawn': string;
    /**
     * Int64, Unix timestamp for the first time member deposited into the CACAOPool
     * @type {string}
     * @memberof CACAOPoolProvider
     */
    'dateFirstAdded': string;
    /**
     * Int64, Unix timestamp for the last time member deposited into the CACAOPool
     * @type {string}
     * @memberof CACAOPoolProvider
     */
 ...
 * 
 * @export
 * @interface CacaoPoolDepositMetadata
 */
export interface CacaoPoolDepositMetadata {
    /**
     * Int64, amount of units assigned to the member as result of the  deposit 
     * @type {string}
     * @memberof CacaoPoolDepositMetadata
     */
    'units': string;
}
/**
 * 
 * @export
 * @interface CacaoPoolWithdrawMetadata
 */
export interface CacaoPoolWithdrawMetadata {
    /**
     * Transaction affiliate address
     * @type {string}
     * @memberof CacaoPoolWithdrawMetadata
     */
    'affiliateAddress': string;
    /**
 ...
 * 
 * @export
 * @interface CacaoPriceHistory
 */
export interface CacaoPriceHistory {
    /**
     * 
     * @type {CacaoPriceIntervals}
     * @memberof CacaoPriceHistory
     */
 ...
 * 
 * @export
 * @interface CacaoPriceIntervals
 */
export interface CacaoPriceIntervals extends Array<CacaoPriceItem> {
}
/**
 * 
 * @export
 * @interface CacaoPriceItem
 */
export interface CacaoPriceItem {
    /**
     * Int64(e8), The price of Cacao based on the USD pools at the the interval 
     * @type {string}
     * @memberof CacaoPriceItem
     */
 ...
 * 
 * @export
 * @interface CacaoPriceMeta
 */
export interface CacaoPriceMeta {
    /**
     * Int64(e8), The price of Cacao based on the USD pools at the end of the interval 
     * @type {string}
     * @memberof CacaoPriceMeta
     */
    'endCacaoPriceUSD': string;
    /**
     * Int64, The end time of bucket in unix timestamp
     * @type {string}
     * @memberof CacaoPriceMeta
    ...
    'endTime': string;
    /**
     * Int64(e8), The price of Cacao based on the USD pools at the start of the interval 
     * @type {string}
     * @memberof CacaoPriceMeta
     */
    'startCacaoPriceUSD': string;
    /**
     * Int64, The beginning time of bucket in unix timestamp
     * @type {string}
     * @memberof CacaoPriceMeta
...
export interface DepthHistoryItem {
    ...
    'membersCount': string;
    /**
     * Array of 4 float values representing the Open, High, Low, Close prices of the asset in usd in the given time interval. The values are in the order of Open, High, Low, Close. 
     * @type {Array<string>}
     * @memberof DepthHistoryItem
     */
    'ohlc': Array<string>;
 ...
 * 
 * @export
 * @interface ItemMayaname
 */
export interface ItemMayaname {
    /**
     * Int64, The count of affiliates with the same mayaname during the time interval 
     * @type {string}
     * @memberof ItemMayaname
     */
    'count': string;
    /**
     * mayaname of the affiliate
     * @type {string}
     * @memberof ItemMayaname
     */
    'mayaname': string;
    /**
     * Int64(e8), The volume of affiliates with the same mayaname detonated in RUNE 
     * @type {string}
     * @memberof ItemMayaname
     */
    'volume': string;
    /**
     * Int64(e2), The volume of affiliates with the same mayaname denoted in USD price of the rune in each swap 
     * @type {string}
     * @memberof ItemMayaname
     */
    'volumeUSD': string;
...
export interface MemberPool {
    ...
    'assetPending': string;
    /**
     * Int64(e8), total asset slashed from the member
     * @type {string}
     * @memberof MemberPool
     */
    'assetSlashed': string;
    ...
    /**
     * Int64(e8), total Cacao that is currently deposited to the pool by member. This field is same as the `rune_deposit_value` field in thornode. Mainly can be used  for tracking, mainly Growth Percentage 
     * @type {string}
     * @memberof MemberPool
     */
    'cacaoDeposit': string;
    /**
     * Int64(e10), total Cacao slashed from the member
     * @type {string}
     * @memberof MemberPool
     */
    'cacaoSlashed': string;
...
export interface Metadata {
     ...
     * @memberof Metadata
     */
    'cacaoPoolDeposit'?: CacaoPoolDepositMetadata;
    /**
     * 
     * @type {CacaoPoolWithdrawMetadata}
     * @memberof Metadata
     */
    'cacaoPoolWithdraw'?: CacaoPoolWithdrawMetadata;
    /**
     * 
     * @type {FailedMetadata}
     * @memberof Metadata
...
export interface StatsData {
    ...
    'cacaoPriceUSD': string;
    /**
     * Int64, number of unique users who made a swap in the last 24h.
     * @type {string}
     * @memberof StatsData
     */
    ...
    'impermanentLossProtectionPaid': string;
    /**
     * Int64, number of unique users who made a swap in the last 30d.
     * @type {string}
     * @memberof StatsData
     */
    ...
    'toRuneCount': string;
    /**
     * Int64, number of unique users who made a swap since beginning.
     * @type {string}
     * @memberof StatsData
     */
    'uniqueSwapperCount': string;
...
export interface SwapHistoryItem {
    ...
    /**
     * Int64(e8), the fees collected from swaps from trade asset to rune (in rune)
     * @type {string}
     * @memberof SwapHistoryItem
     */
    ...
    'toTradeFees': string;
    /**
     * Int64(e8), volume of swaps from rune to trade denoted in rune
     * @type {string}
     * @memberof SwapHistoryItem
     */
...
export interface THORNameDetails {
    /**
     * Int64, affiliate fee in basis points
     * @type {string}
    ...
    'owner': string;
    /**
     * Preferred asset for the THORName owner to receive fees in
     * @type {string}
     * @memberof THORNameDetails
     */
    'preferred_asset': string;
    /**
     * Int64, THORChain block height in which THORName is registered
     * @type {string}
     * @memberof THORNameDetails
     */
    'registration_block': string;
    /**
     * List details of all sub affiliates for a given THORName
     * @type {Array<THORNameSubAffiliate>}
     * @memberof THORNameDetails
     */
    'sub_affiliates': Array<THORNameSubAffiliate>;
}
/**
 * 
 * @export
 ...
 * 
 * @export
 * @interface THORNameSubAffiliate
 */
export interface THORNameSubAffiliate {
    /**
     * Int64, affiliate fee in basis points
     * @type {string}
     * @memberof THORNameSubAffiliate
     */
    'affiliate_bps': string;
    /**
     * Int64, THORChain block height in which THORName expires
    ...
    'name': string;
    /**
     * Int64, share of this sub affiliate from the main name in basis points
     * @type {string}
     * @memberof THORNameSubAffiliate
     */
    'share_bps': string;
...
export interface Transaction {
    ...
    'address': string;
    /**
     * If transactions flagged as affiliate
     * @type {boolean}
     * @memberof Transaction
     */
    'affiliate'?: boolean;
...
export const DefaultApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getActions: async (address?: string, txid?: string, asset?: string, type?: string, affiliate?: string, limit?: number, offset?: number, nextPageToken?: number, timestamp?: number, height?: number, prevPageToken?: number, fromTimestamp?: number, fromHeight?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getAffiliateHistory: async (mayaname?: string, interval?: '5min' | 'hour' | 'day' | 'week' | 'month' | 'quarter' | 'year', count?: number, to?: number, from?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @param {string} address Address to match borrower, an asset address is given. Query can also be multiple addresses should be seperated by comma (\&#39;,\&#39;) 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
         ...
         * @throws {RequiredError}
         */
        getCACAOPoolDetail: async (address: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'address' is not null or undefined
            assertParamExists('getCACAOPoolDetail', 'address', address)
         ...
         * @throws {RequiredError}
         */
        getCacaoPoolHistory: async (interval?: '5min' | 'hour' | 'day' | 'week' | 'month' | 'quarter' | 'year', count?: number, to?: number, from?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getCacaoPriceHistory: async (interval?: '5min' | 'hour' | 'day' | 'week' | 'month' | 'quarter' | 'year', count?: number, to?: number, from?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @param {string} address Address to match liquidity providers. Either a rune or an asset address may be given. Query can also be multiple addresses should be seperated by comma (\&#39;,\&#39;) 
         ...
         * @param {'1h' | '24h' | '7d' | '14d' | '30d' | '90d' | '100d' | '180d' | '365d' | 'all'} [period] Specifies the base interval from which APY is extrapolated. Default is 30d. 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
         ...
         * @param {string} asset pool name
         * @param {'1h' | '24h' | '7d' | '14d' | '30d' | '90d' | '100d' | '180d' | '365d' | 'all'} [period] Restricts aggregation type fields to the last period only. Default is 30d. 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
...
export const DefaultApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getActions(address?: string, txid?: string, asset?: string, type?: string, affiliate?: string, limit?: number, offset?: number, nextPageToken?: number, timestamp?: number, height?: number, prevPageToken?: number, fromTimestamp?: number, fromHeight?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetActions200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getActions(address, txid, asset, type, affiliate, limit, offset, nextPageToken, timestamp, height, prevPageToken, fromTimestamp, fromHeight, options);
         ...
         * @throws {RequiredError}
         */
        async getAffiliateHistory(mayaname?: string, interval?: '5min' | 'hour' | 'day' | 'week' | 'month' | 'quarter' | 'year', count?: number, to?: number, from?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AffiliateHistory>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAffiliateHistory(mayaname, interval, count, to, from, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Returns all coin amounts of the given address at the specified timestamp or height, or at the latest process block if neither is provided. (Only one of timestamp or height can be specified, not both.)  This endpoint is enabled only if the midgard startup config allows it. 
         ...
         * @throws {RequiredError}
         */
        async getCACAOPoolDetail(address: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CACAOPoolDetails>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getCACAOPoolDetail(address, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Returns CacaoPool members and units. The values report the state at the end of each interval.  History endpoint has two modes: * With Interval parameter it returns a series of time buckets. From and To dates will   be rounded to the Interval boundaries. * Without Interval parameter a single From..To search is performed with exact timestamps.   * Interval: possible values: 5min, hour, day, week, month, quarter, year. * count: [1..400]. Defines number of intervals. Don\'t provide if Interval is missing. * from/to: optional int, unix second.  Possible usages with interval. * last 10 days: `?interval=day&count=10` * last 10 days before to: `?interval=day&count=10&to=1608825600` * next 10 days after from: `?interval=day&count=10&from=1606780800` * Days between from and to. From defaults to start of chain, to defaults to now.   Only the first 400 intervals are returned:   `interval=day&from=1606780800&to=1608825600`  Pagination is possible with from&count and then using the returned meta.endTime as the From parameter of the next query.  Possible configurations without interval: * exact search for one time frame: `?from=1606780899&to=1608825600` * one time frame until now: `?from=1606780899` * from chain start until now: no query parameters 
         ...
         * @throws {RequiredError}
         */
        async getCacaoPoolHistory(interval?: '5min' | 'hour' | 'day' | 'week' | 'month' | 'quarter' | 'year', count?: number, to?: number, from?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CACAOPoolHistory>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getCacaoPoolHistory(interval, count, to, from, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Returns cacao price history in USD based on the time bucket given 
         ...
         * @throws {RequiredError}
         */
        async getCacaoPriceHistory(interval?: '5min' | 'hour' | 'day' | 'week' | 'month' | 'quarter' | 'year', count?: number, to?: number, from?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CacaoPriceHistory>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getCacaoPriceHistory(interval, count, to, from, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Returns block height and timestamp for each churn.
...
export const DefaultApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getActions(address?: string, txid?: string, asset?: string, type?: string, affiliate?: string, limit?: number, offset?: number, nextPageToken?: number, timestamp?: number, height?: number, prevPageToken?: number, fromTimestamp?: number, fromHeight?: number, options?: any): AxiosPromise<GetActions200Response> {
            return localVarFp.getActions(address, txid, asset, type, affiliate, limit, offset, nextPageToken, timestamp, height, prevPageToken, fromTimestamp, fromHeight, options).then((request) => request(axios, basePath));
        },
        /**
         * Returns affiliate count, volume in specified interval. If thorname is not specified returns all thornames  History endpoint has two modes: * With Interval parameter it returns a series of time buckets. From and To dates will   be rounded to the Interval boundaries. * Without Interval parameter a single From..To search is performed with exact timestamps.   * Interval: possible values: 5min, hour, day, week, month, quarter, year. * count: [1..400]. Defines number of intervals. Don\'t provide if Interval is missing. * from/to: optional int, unix second.  Possible usages with interval. * last 10 days: `?interval=day&count=10` * last 10 days before to: `?interval=day&count=10&to=1608825600` * next 10 days after from: `?interval=day&count=10&from=1606780800` * Days between from and to. From defaults to start of chain, to defaults to now.   Only the first 400 intervals are returned:   `interval=day&from=1606780800&to=1608825600`  Pagination is possible with from&count and then using the returned meta.endTime as the From parameter of the next query.  Possible configurations without interval: * exact search for one time frame: `?from=1606780899&to=1608825600` * one time frame until now: `?from=1606780899` * from chain start until now: no query parameters 
         * @summary Affiliate History
         ...
         * @throws {RequiredError}
         */
        getAffiliateHistory(mayaname?: string, interval?: '5min' | 'hour' | 'day' | 'week' | 'month' | 'quarter' | 'year', count?: number, to?: number, from?: number, options?: any): AxiosPromise<AffiliateHistory> {
            return localVarFp.getAffiliateHistory(mayaname, interval, count, to, from, options).then((request) => request(axios, basePath));
        },
        /**
         * Returns all coin amounts of the given address at the specified timestamp or height, or at the latest process block if neither is provided. (Only one of timestamp or height can be specified, not both.)  This endpoint is enabled only if the midgard startup config allows it. 
         * @summary Current balance for an address
         ...
         * @throws {RequiredError}
         */
        getCACAOPoolDetail(address: string, options?: any): AxiosPromise<CACAOPoolDetails> {
            return localVarFp.getCACAOPoolDetail(address, options).then((request) => request(axios, basePath));
        },
        /**
         * Returns CacaoPool members and units. The values report the state at the end of each interval.  History endpoint has two modes: * With Interval parameter it returns a series of time buckets. From and To dates will   be rounded to the Interval boundaries. * Without Interval parameter a single From..To search is performed with exact timestamps.   * Interval: possible values: 5min, hour, day, week, month, quarter, year. * count: [1..400]. Defines number of intervals. Don\'t provide if Interval is missing. * from/to: optional int, unix second.  Possible usages with interval. * last 10 days: `?interval=day&count=10` * last 10 days before to: `?interval=day&count=10&to=1608825600` * next 10 days after from: `?interval=day&count=10&from=1606780800` * Days between from and to. From defaults to start of chain, to defaults to now.   Only the first 400 intervals are returned:   `interval=day&from=1606780800&to=1608825600`  Pagination is possible with from&count and then using the returned meta.endTime as the From parameter of the next query.  Possible configurations without interval: * exact search for one time frame: `?from=1606780899&to=1608825600` * one time frame until now: `?from=1606780899` * from chain start until now: no query parameters 
         * @summary CacaoPool total members and units History
         ...
         * @throws {RequiredError}
         */
        getCacaoPoolHistory(interval?: '5min' | 'hour' | 'day' | 'week' | 'month' | 'quarter' | 'year', count?: number, to?: number, from?: number, options?: any): AxiosPromise<CACAOPoolHistory> {
            return localVarFp.getCacaoPoolHistory(interval, count, to, from, options).then((request) => request(axios, basePath));
        },
        /**
         * Returns cacao price history in USD based on the time bucket given 
         * @summary Cacao price history in USD
         ...
         * @throws {RequiredError}
         */
        getCacaoPriceHistory(interval?: '5min' | 'hour' | 'day' | 'week' | 'month' | 'quarter' | 'year', count?: number, to?: number, from?: number, options?: any): AxiosPromise<CacaoPriceHistory> {
            return localVarFp.getCacaoPriceHistory(interval, count, to, from, options).then((request) => request(axios, basePath));
        },
        /**
         * Returns block height and timestamp for each churn.
         * @summary Churns List
...
export class DefaultApi extends BaseAPI {
     ...
     * @memberof DefaultApi
     */
    public getActions(address?: string, txid?: string, asset?: string, type?: string, affiliate?: string, limit?: number, offset?: number, nextPageToken?: number, timestamp?: number, height?: number, prevPageToken?: number, fromTimestamp?: number, fromHeight?: number, options?: AxiosRequestConfig) {
        return DefaultApiFp(this.configuration).getActions(address, txid, asset, type, affiliate, limit, offset, nextPageToken, timestamp, height, prevPageToken, fromTimestamp, fromHeight, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DefaultApi
     */
    public getAffiliateHistory(mayaname?: string, interval?: '5min' | 'hour' | 'day' | 'week' | 'month' | 'quarter' | 'year', count?: number, to?: number, from?: number, options?: AxiosRequestConfig) {
        return DefaultApiFp(this.configuration).getAffiliateHistory(mayaname, interval, count, to, from, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DefaultApi
     */
    public getCACAOPoolDetail(address: string, options?: AxiosRequestConfig) {
        return DefaultApiFp(this.configuration).getCACAOPoolDetail(address, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DefaultApi
     */
    public getCacaoPoolHistory(interval?: '5min' | 'hour' | 'day' | 'week' | 'month' | 'quarter' | 'year', count?: number, to?: number, from?: number, options?: AxiosRequestConfig) {
        return DefaultApiFp(this.configuration).getCacaoPoolHistory(interval, count, to, from, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DefaultApi
     */
    public getCacaoPriceHistory(interval?: '5min' | 'hour' | 'day' | 'week' | 'month' | 'quarter' | 'year', count?: number, to?: number, from?: number, options?: AxiosRequestConfig) {
        return DefaultApiFp(this.configuration).getCacaoPriceHistory(interval, count, to, from, options).then((request) => request(this.axios, this.basePath));
    }
