...
var require$$0$1 = getCjsExportFromNamespace(chinese_simplified$1);
...
var ZEROS$1 = Buffer$i.alloc(128);
var blocksize = 64;
...
function Hmac$1 (alg, key) {
  ...
  if (key.length > blocksize) {
    ...
    key = Buffer$i.concat([key, ZEROS$1], blocksize);
  }

  var ipad = this._ipad = Buffer$i.allocUnsafe(blocksize);
  var opad = this._opad = Buffer$i.allocUnsafe(blocksize);
...
Hmac$1.prototype._final = function () {
  var h = this._alg(Buffer$i.concat(this._hash));
  return this._alg(Buffer$i.concat([this._opad, h]))
};
var legacy = Hmac$1;
...
function Hmac$2 (alg, key) {
  ...
  var ipad = this._ipad = Buffer$j.allocUnsafe(blocksize);
  var opad = this._opad = Buffer$j.allocUnsafe(blocksize);
...
function hash160(buffer) {
    const sha256Hash = browser$1('sha256')
        .update(buffer)
        .digest();
    try {
...
var base$1 = function (checksumFn) {
  ...
  function encode (payload) {
    ...
    return bs58.encode(Buffer$k.concat([
      payload,
      checksum
    ], payload.length + 4))
  }
...
function deterministicGenerateK (hash, x, checkSig, isPrivate, extraEntropy) {
  ...
  // Step E
  v = browser$4('sha256', k).update(v).digest();
...
function encode$1 (r, s) {
  ...
  var signature = Buffer$l.allocUnsafe(6 + lenR + lenS);
...
function makeRandom(options) {
  typeforce_1(isOptions, options);
  if (options === undefined) options = {};
  const rng = options.rng || browser$3;
  let d;
  do {
    d = rng(32);
...
function encode$4 (number, buffer, offset) {
  ...
  if (!buffer) buffer = Buffer$m.allocUnsafe(encodingLength$1(number));
  if (!Buffer$m.isBuffer(buffer)) throw new TypeError('buffer must be a Buffer instance')
  if (!offset) offset = 0;
...
var baseUrl = 'https://api.blockchair.com/bitcoin/';
var pathAddress = 'dashboards/address/';
var pathTx = 'raw/transaction/';
/**
...
var Client = /** @class */ (function () {
    ...
    function Client(_net, _phrase) {
        ...
        this.scanUTXOs = function (address) { return __awaiter(_this, void 0, void 0, function () {
            var pathNetwork, response, utxo, i, txHash, value, index, txRx, script, witness, utxoObject, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        pathNetwork = '';
                        if (this.net === exports.Network.TEST) {
                            pathNetwork = 'testnet/';
                        }
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 7, , 8]);
                        return [4 /*yield*/, axios.get(baseUrl + pathNetwork + pathAddress + address)];
                    case 2:
                        response = _a.sent();
                        utxo = response.data.data[address].utxo;
                        i = 0;
                        _a.label = 3;
                    case 3:
                        if (!(i < utxo.length)) return [3 /*break*/, 6];
                        txHash = utxo[i].transaction_hash;
                        value = utxo[i].value;
                        index = utxo[i].index;
                        return [4 /*yield*/, axios.get(baseUrl + pathNetwork + pathTx + txHash)];
                    case 4:
                        txRx = _a.sent();
                        script = txRx.data.data[txHash].decoded_raw_transaction.vout[index].scriptPubKey.hex;
                        witness = {
                            value: value,
        ...
        this.getTransactions = function (address) { return __awaiter(_this, void 0, void 0, function () {
            var pathNetwork, transactions, response, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        pathNetwork = '';
