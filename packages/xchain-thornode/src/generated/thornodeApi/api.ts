...
export const QuoteApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        quoteloanclose: async (height?: number, asset?: string, amount?: number, loanAsset?: string, loanOwner?: string, minOut?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const QuoteApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async quoteloanclose(height?: number, asset?: string, amount?: number, loanAsset?: string, loanOwner?: string, minOut?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<QuoteLoanCloseResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.quoteloanclose(height, asset, amount, loanAsset, loanOwner, minOut, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Provide a quote estimate for the provided loan open.
...
export class QuoteApi extends BaseAPI {
     ...
     * @memberof QuoteApi
     */
    public quoteloanclose(height?: number, asset?: string, amount?: number, loanAsset?: string, loanOwner?: string, minOut?: string, options?: AxiosRequestConfig) {
