...
export const QuoteApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        quoteloanclose: async (height?: number, asset?: string, amount?: number, fromAddress?: string, loanAsset?: string, loanOwner?: string, minOut?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        quoteloanopen: async (height?: number, asset?: string, amount?: number, targetAsset?: string, destination?: string, minOut?: string, affiliateBps?: number, affiliate?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        quoteswap: async (height?: number, fromAsset?: string, toAsset?: string, amount?: number, destination?: string, fromAddress?: string, toleranceBps?: number, affiliateBps?: number, affiliate?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const QuoteApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async quoteloanclose(height?: number, asset?: string, amount?: number, fromAddress?: string, loanAsset?: string, loanOwner?: string, minOut?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<QuoteLoanCloseResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.quoteloanclose(height, asset, amount, fromAddress, loanAsset, loanOwner, minOut, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Provide a quote estimate for the provided loan open.
         ...
         * @throws {RequiredError}
         */
        async quoteloanopen(height?: number, asset?: string, amount?: number, targetAsset?: string, destination?: string, minOut?: string, affiliateBps?: number, affiliate?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<QuoteLoanOpenResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.quoteloanopen(height, asset, amount, targetAsset, destination, minOut, affiliateBps, affiliate, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Provide a quote estimate for the provided saver deposit.
         ...
         * @throws {RequiredError}
         */
        async quoteswap(height?: number, fromAsset?: string, toAsset?: string, amount?: number, destination?: string, fromAddress?: string, toleranceBps?: number, affiliateBps?: number, affiliate?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<QuoteSwapResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.quoteswap(height, fromAsset, toAsset, amount, destination, fromAddress, toleranceBps, affiliateBps, affiliate, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export class QuoteApi extends BaseAPI {
     ...
     * @memberof QuoteApi
     */
    public quoteloanclose(height?: number, asset?: string, amount?: number, fromAddress?: string, loanAsset?: string, loanOwner?: string, minOut?: string, options?: AxiosRequestConfig) {
     ...
     * @memberof QuoteApi
     */
    public quoteloanopen(height?: number, asset?: string, amount?: number, targetAsset?: string, destination?: string, minOut?: string, affiliateBps?: number, affiliate?: string, options?: AxiosRequestConfig) {
     ...
     * @memberof QuoteApi
     */
    public quoteswap(height?: number, fromAsset?: string, toAsset?: string, amount?: number, destination?: string, fromAddress?: string, toleranceBps?: number, affiliateBps?: number, affiliate?: string, options?: AxiosRequestConfig) {
