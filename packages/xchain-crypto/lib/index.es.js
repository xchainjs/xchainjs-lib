...
var pbkdf2Async = function (passphrase, salt, iterations, keylen, digest) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, new Promise(function (resolve, reject) {
                crypto$2.pbkdf2(passphrase, salt, iterations, keylen, digest, function (err, drived) {
                    if (err) {
                        reject(err);
                    }
                    else {
...
var encryptToKeyStore = function (phrase, password) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ID = uuidv4();
                salt = crypto$2.randomBytes(32);
                iv = crypto$2.randomBytes(16);
                kdfParams = {
                    prf: prf,
                    dklen: dklen,
            ...
            case 1:
                derivedKey = _a.sent();
                cipherIV = crypto$2.createCipheriv(cipher, derivedKey.slice(0, 16), iv);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                decipher = crypto$2.createDecipheriv(keystore.crypto.cipher, derivedKey.slice(0, 16), Buffer.from(keystore.crypto.cipherparams.iv, 'hex'));
...
export { decryptFromKeystore, encryptToKeyStore, generatePhrase, getAddress, getPublicKeyPair, getSeed, validatePhrase };
