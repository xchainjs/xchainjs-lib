...
var CosmosSDKClient = /** @class */ (function () {
    ...
    function CosmosSDKClient(_a) {
        ...
        this.getPrivKeyFromMnemonic = function (mnemonic) {
            ...
            return new PrivKeySecp256k1$1(child.privateKey);
        };
...
export { AssetAtom, AssetMuon, Client, CosmosChain, CosmosSDKClient, getAsset, getDenom, getQueryString, getTxsFromHistory, isMsgMultiSend, isMsgSend };
