...
import { defaultEthParams } from '../src'
import Client from '../src/client'

defaultEthParams.phrase = 'canyon throw labor waste awful century ugly they found post source draft'
...
describe('Client Test', () => {
  ...
  it('derive path correctly with bip44', () => {
    const ethClient = new Client(defaultEthParams)
