...
var crypto$2 = require('@binance-chain/javascript-sdk/lib/crypto');
...
var PubKeySecp256k1 = /** @class */ (function () {
    ...
    PubKeySecp256k1.prototype.hash160 = function (buffer) {
        var sha256Hash = crypto$1.createHash('sha256').update(buffer).digest();
        try {
            return crypto$1.createHash('rmd160').update(sha256Hash).digest();
        }
        catch (err) {
            return crypto$1.createHash('ripemd160').update(sha256Hash).digest();
        }
    };
    ...
    PubKeySecp256k1.prototype.verify = function (signature, message) {
        var hash = crypto$1.createHash('sha256').update(message).digest();
 ...
 */
var isFreezeFee = function (v) { var _a; return ((_a = v) === null || _a === void 0 ? void 0 : _a.msg_type) === 'tokensFreeze'; };
/**
    ...
    function Client(_a) {
        ...
        this.getPrivateKey = function () {
            if (!_this.privateKey) {
                ...
                _this.privateKey = crypto$2.getPrivateKeyFromMnemonic(_this.phrase);
            }
            return _this.privateKey;
        };
        this.getAddress = function () {
            if (!_this.address) {
                var address = crypto$2.getAddressFromPrivateKey(_this.getPrivateKey(), _this.getPrefix());
                if (!address) {
