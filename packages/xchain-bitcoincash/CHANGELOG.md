...
- Updated dependencies [4ec2e3e]
  ...
  - @xchainjs/xchain-utxo-providers@2.0.18
...
- 9069989: Switched recipient address handling to use CashAddr format so it works properly with bitcore. Replaced BTC-style addresses with recipientCashAddress in transaction outputs, and updated change outputs to use CashAddr as well for consistency.
...
- Updated dependencies [3dd82dd]
  ...
  - @xchainjs/xchain-utxo@2.2.2
  - @xchainjs/xchain-utxo-providers@2.0.12

## 2.2.1

### Patch Changes

- Updated dependencies [cd3abad]
...
- 134bbbd: Remove bchaddr dependency
...
- d2ab59a: Update core dependency
