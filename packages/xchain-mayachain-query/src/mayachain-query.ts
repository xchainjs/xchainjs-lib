  ...
  public async quoteSwap({
    ...
    if (response.error) {
      return {
        ...
        fees: {
          ...
          liquidity: new CryptoAmount(
            baseAmount(0, toAssetString === assetToString(CacaoAsset) ? 10 : 8),
            destinationAsset,
          ),
          total: new CryptoAmount(
            baseAmount(0, toAssetString === assetToString(CacaoAsset) ? 10 : 8),
            destinationAsset,
          ),
        },
    ...
    return {
      ...
      fees: {
        ...
        liquidity: new CryptoAmount(baseAmount(swapQuote.fees.liquidity, isFeeAssetCacao ? 10 : 8), feeAsset),
        total: new CryptoAmount(baseAmount(swapQuote.fees.total, isFeeAssetCacao ? 10 : 8), feeAsset),
      },
      ...
      streamingSwapSeconds: swapQuote.inbound_confirmation_seconds ? swapQuote.inbound_confirmation_seconds : 0,
