...
const AssetDOT = { chain: xchainUtil.Chain.Polkadot, symbol: 'DOT', ticker: 'DOT', synth: false };
...
const getDefaultFees = (network) => {
    const fee = xchainUtil.assetToBase(xchainUtil.assetAmount(0.015, getDecimal(network)));
...
class Client {
    ...
    constructor({ network = xchainClient.Network.Testnet, phrase, rootDerivationPaths = {
        [xchainClient.Network.Mainnet]: "44//354//0//0//0'",
        [xchainClient.Network.Testnet]: "44//354//0//0//0'",
        [xchainClient.Network.Stagenet]: "44//354//0//0//0'",
    }, }) {
        this.phrase = '';
    ...
    getKeyringPair(index) {
        const key = new api.Keyring({ ss58Format: this.getSS58Format(), type: 'ed25519' });
    ...
    getAPI() {
        return __awaiter(this, void 0, void 0, function* () {
            const api$1 = new api.ApiPromise({ provider: new api.WsProvider(this.getWsEndpoint()) });
            yield api$1.isReady;
            if (!api$1.isConnected)
                yield api$1.connect();
            return api$1;
        });
    }
    ...
    getBalance(address, assets) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = (yield axios__default['default'].post(`${this.getClientUrl()}/api/open/account`, { address: address || this.getAddress() })).data;
            if (!isSuccess(response))
                throw new Error('Invalid address');
            const account = response.data;
            return account && (!assets || assets.filter((asset) => xchainUtil.assetToString(AssetDOT) === xchainUtil.assetToString(asset)).length)
                ? [
                    {
                        asset: AssetDOT,
    ...
    getTransactions(params) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = (yield axios__default['default'].post(`${this.getClientUrl()}/api/scan/transfers`, {
    ...
    getTransactionData(txId) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = (yield axios__default['default'].post(`${this.getClientUrl()}/api/scan/extrinsic`, { hash: txId })).data;
            if (!isSuccess(response) || !response.data)
                throw new Error('Failed to get transactions');
    ...
    transfer(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const fee = xchainUtil.baseAmount(paymentInfo.partialFee.toString(), getDecimal(this.network));
    ...
    estimateFees(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const fee = xchainUtil.baseAmount(info.partialFee.toString(), getDecimal(this.network));
            yield api.disconnect();
            return xchainClient.singleFee(xchainClient.FeeType.PerByte, fee);
        });
    }
