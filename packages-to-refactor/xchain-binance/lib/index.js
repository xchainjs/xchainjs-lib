 ...
 */
const parseTx = (tx) => {
    const asset = xchainUtil.assetFromString(`${xchainUtil.AssetBNB.chain}.${tx.txAsset}`);
    if (!asset)
        return null;
    return {
        asset,
...
class Client extends xchainClient.BaseXChainClient {
     ...
     */
    constructor(params) {
        super(xchainUtil.Chain.Binance, params);
    ...
    getNetwork() {
        switch (super.getNetwork()) {
            case xchainClient.Network.Mainnet:
            case xchainClient.Network.Stagenet:
                return xchainClient.Network.Mainnet;
            case xchainClient.Network.Testnet:
                return xchainClient.Network.Testnet;
        }
    }
    /**
    ...
    getBalance(address, assets) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return balances
                .map((balance) => {
                return {
                    asset: xchainUtil.assetFromString(`${xchainUtil.Chain.Binance}.${balance.symbol}`) || xchainUtil.AssetBNB,
    ...
    transfer({ walletIndex, asset, amount, recipient, memo }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const transferResult = yield this.bncClient.transfer(this.getAddress(walletIndex), recipient, xchainUtil.baseToAsset(amount).amount().toString(), asset ? asset.symbol : xchainUtil.AssetBNB.symbol, memo);
            return transferResult.result.map((txResult) => { var _a; return (_a = txResult === null || txResult === void 0 ? void 0 : txResult.hash) !== null && _a !== void 0 ? _a : ''; })[0];
        });
    }
    /**
